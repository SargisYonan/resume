...
\begin{enumerate}[leftmargin=*]
    ...
    \squareitem Collaborate with image signal processing teams to architect interprocess communications, commanding, optimize system performance, and ensure feature compatibility.
    ...
    \squareitem Contributed and shipped dozens of major features and low-level camera system software stacks on all Apple devices with cameras.
    \squareitem Working closely with the factory team to ensure successful production ramping across hardware build phases and lifecycles.
    \squareitem Extensive experience with system-level high permformance low latency data delivery across the camera software and hardware stack.
\end{enumerate}
\end{tabular} \\
...
%% Masters
\begin{tabular}[t]{@{\extracolsep{\fill}} p{\tablefillwidth}}
    {\large{\textbf{M.Sc. Robotics Engineering}}} \hspace*{\fill} \textbf{September 2017 - December 2018} \\
...
%% Bachelors
\begin{tabular}[t]{@{\extracolsep{\fill}} p{\tablefillwidth}}
    {\large{\textbf{B.S. Computer Engineering}}} \hspace*{\fill} \textbf{September 2013 - June 2017} \\
...
%% Minor
\begin{tabular}[t]{@{\extracolsep{\fill}} p{\tablefillwidth}}
    {\large{\textbf{Minor Computer Science}}} \hspace*{\fill} \textbf{September 2013 - June 2017} \\
